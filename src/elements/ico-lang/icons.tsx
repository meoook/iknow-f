...
const IcoUA = () => (
  <svg viewBox='0 0 300 200' width='30' height='20'>
    <rect width='300' height='100' fill='#2A75E6' />
    <rect width='300' height='100' fill='#F9D549' y='100' />
  </svg>
)
